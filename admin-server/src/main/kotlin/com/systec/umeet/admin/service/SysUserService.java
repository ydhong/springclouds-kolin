...
import com.systec.umeet.admin.mapper.*;
import com.systec.umeet.admin.model.*;
import com.systec.umeet.admin.util.MenuTreeUtil;
import com.systec.umeet.admin.vo.SysUserDetail;
import com.systec.umeet.admin.vo.SysUserInfo;
import com.systec.umeet.common.utils.ListUtils;
import com.systec.umeet.common.utils.SnowFlake;
    ...
    public SysUserDetail selectUserDetail(Long userId) {
        ...
        if (!ListUtils.isEmpty(roleList)) {
            ...
            roleList = roleList.stream().collect(
                    ...
                    new TreeSet<>(comparingLong(SysRole::getId))), ArrayList::new));
