...
object  FastJsonUtils {
     ...
     * 生成json返回结果
     */
    fun resultSuccess(status: Int?, msg: String, data: Any?): String {
    ...
    fun resultError(status: Int?, error: String, data: Any?): String {
        val rs = HashMap<String, Any>()
        rs.put("status", status!!)
        rs.put("data", data ?: Any())
        rs.put("message", if (StringUtils.isNotEmpty(error)) error else "")
        return toString(rs)
    }
     ...
     * 生成json返回结果
     */
    fun resultList(status: Int?, msg: String, pageNo: Int?, pageSize: Int?, data: Any?): String {
        val rs = HashMap<String, Any>()
        rs.put("status", status!!)
        rs.put("msg", if (StringUtils.isNotEmpty(msg)) msg else SUCCESS_MSG)
        rs.put("data", data ?: Any())
     ...
     * 生成json返回结果
     */
    fun resultFeatures(status: Int?, msg: String, data: Any?, vararg feature: SerializerFeature): String {
        val rs = HashMap<String, Any>()
        rs.put("status", status!!)
        rs.put("msg", if (StringUtils.isNotEmpty(msg)) msg else SUCCESS_MSG)
        rs.put("data", data ?: Any())
     ...
     * 生成json返回结果
     */
    fun resultDate(status: Int?, msg: String, data: Any?, dateFormat: String): String {
        val rs = HashMap<String, Any>()
        rs.put("status", status!!)
        rs.put("msg", if (StringUtils.isNotEmpty(msg)) msg else SUCCESS_MSG)
        rs.put("data", data ?: Any())
     ...
     * 生成json返回结果,包含字段
     */
    fun resultIncludes(status: Int?, msg: String, data: Any?, vararg properties: String): String {
        val rs = HashMap<String, Any>()
        rs.put("status", status!!)
        rs.put("msg", if (StringUtils.isNotEmpty(msg)) msg else SUCCESS_MSG)
        rs.put("data", data ?: Any())
     ...
     * 生成json返回结果,包含字段
     */
    fun resultExcludes(status: Int?, msg: String, data: Any?, type: Class<*>, vararg properties: String): String {
        val rs = HashMap<String, Any>()
        rs.put("status", status!!)
        rs.put("msg", if (StringUtils.isNotEmpty(msg)) msg else SUCCESS_MSG)
        rs.put("data", data ?: Any())
    ...
    private fun toStringIncludes(data: Any, vararg properties: String): String {
        val filter = PropertyFilter { source, name, value ->
            if (source.javaClass == HashMap::class.java && ("status" == name || "data" == name || "msg" == name)) {
