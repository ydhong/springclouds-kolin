package com.umeet.conference.conf

import com.umeet.conference.interceptor.LoginInterceptor
...
open class WebMvcConfig: WebMvcConfigurerAdapter() {
    ...
    override fun addInterceptors(registry: InterceptorRegistry?) {
        ...
        registry!!.addInterceptor(loginInterceptor).addPathPatterns("/umeet/**")
                .excludePathPatterns("/umeet/loggin", "/umeet/logout", "/umeet/configs", "/umeet/verify", "/static/**", "/upload/**", "/resoures/**", "swagger-resources/**", "/v2/api-docs")
